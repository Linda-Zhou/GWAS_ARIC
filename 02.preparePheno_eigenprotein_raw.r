...
prot<-args[2]
protein<-paste0(transformation,prot)
visit<-args[3]
...
aric_proteinsfile   <-	"../datasets/Keenan/ME 580 V3.xlsx"
aric_proteins<-read.xlsx(aric_proteinsfile, sheetName="ME 580 V3")

}
if (visit==5){
aric_covariatesfile <- "../datasets/ARICv5_covariates.csv"
aric_proteinsfile   <- "../datasets/Keenan/ME 580 V5.xlsx"
aric_proteins<-read.xlsx(aric_proteinsfile, sheetName="ME 580 V5")
}
...
setnames(aric_proteins, "id", "IID")
setnames(aric_proteins, prot, protein)
